	...
	public class ItemDefinitions {
		...
		public static const definitions:Object = {
			...
			"Digestive"			: { name		: "Digestive",
									...
									value		: 50,
									effects		: [function():Array { return ["fat", (getStat("currCapacity") <= 0) ? 0 : Math.round(Math.round(getStat("currCapacity") * 0.25) / (getStat("metabolism") / 2))] },
			...
			"Super Digestive"	: { name		: "Super Digestive",
									...
									value		: 100,
									effects		: [function():Array { return ["fat", (getStat("currCapacity") <= 0) ? 0 : Math.round(Math.round(getStat("currCapacity") * 0.5) / (getStat("metabolism") / 3))] },
			...
			"Max Digestive"		: { name		: "Max Digestive",
									...
									value		: 500,
									effects		: [function():Array { return ["fat", (getStat("currCapacity") <= 0) ? 0 : Math.round(getStat("currCapacity") / (getStat("metabolism") / 4))] },
