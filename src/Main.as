package  {
	...
	public class Main extends MovieClip {
		...
		public static var credits:Array = ["PowersNDark", "Mysticmightg", "Sinwraith", "Serule", "Kazan.K", "PsychicImmortality"];
